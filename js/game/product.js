    ...
    class Product {
        ...
        */
        ...
        static randomUpdateConsumtion(world, product1 = undefined, product2 = undefined, proz = undefined, changeBuildings = false) {
            ...
            var sproz2 = ((prod2.dailyConsumtion - proz2) * 100 / prod2.dailyConsumtion) * -1;
            world.game.statistic.lastPriceChange = "change price " + prod1.name + " -" + Math.round(proz * 10000) / 10000 + "% and " + prod2.name + " +" + Math.round(sproz2 * 10000) / 10000 + "%";
